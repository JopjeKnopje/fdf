...
/*   Updated: 2023/06/20 11:56:01 by jboeve        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
const t_mat3x3	get_matrix_ortho(void);
const t_mat3x3	get_matrix_iso(void);
...
// color.c
t_rgba			color_gradient(t_rgba c_start, t_rgba c_end, int32_t step, int32_t len);
